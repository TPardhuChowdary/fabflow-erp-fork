...
--     never a foreign key, by explicit design (Phase 32 Section D/I) - a real FK
...
--   C. No existing table can safely host this new data - see Phase 32 Section C
...
create table if not exists public.project_qms_inspections (
  ...
  -- IndexedDB, out of scope for this migration (Phase 32 Section A). No FK is
...
create table if not exists public.project_qms_inspection_attempt_photos (
  ...
  -- PurchasedItemAttachment - not Supabase Storage (Phase 32 Section K, this
